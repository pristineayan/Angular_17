...
@Component({
  selector: 'app-root',
  standalone: true,
  imports: [RouterOutlet,NgxSpinnerModule,MatIconModule,CommonModule],
...
export class AppComponent {
  ...
  updateLoadingTextAndStyle(): void {
    this.textindex = Math?.floor(Math?.random() * this.funny_loading_text?.length);
    this.styleindex = Math?.floor(Math?.random() * this.loading_style?.length);
    console.log(`Text: ${this.funny_loading_text[this.textindex]}, Style: ${this.loading_style[this.styleindex]}`);
  }
